...
In the excel sheet Asian_Chinese, the first column is the user_id. The second and third column indicates the
...
The weighing and discounting operations are done by using the semantic similarity measures. 
...
Similarily excel sheet named Buddhist_Chinese has the previously listed procedure repeated for the annotations Buddhist and Chinese.

Excel sheets Asian_Chinese(probabilistic) and Buddhist_Chinese(probabilistic) computes the opinion based on Wikipedia similarity measure.

Large_dataset contains the values for the experiment performed on 1000 values for observing the difference between weighing and discounting operators.